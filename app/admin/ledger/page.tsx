    ...
    <div className="min-h-screen bg-[#0b0c10] text-[#EAE5D9] font-sans pb-16">
      ...
      <header className="border-b border-[#D4AF37]/20 bg-[#0b0c10]/90 backdrop-blur sticky top-0 z-20 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <i className="fa-solid fa-clock-rotate-left text-[#D4AF37] text-xl"></i>
          <div>
            <h1 className="font-serif text-lg tracking-wider text-white">Booking Ledger</h1>
            <p className="text-[10px] text-white/40 uppercase tracking-widest font-semibold">Historical Reservations Archive</p>
          </div>
        </div>
      </header>
      ...
      <main className="p-6 max-w-7xl mx-auto space-y-6">
        ...
        {isLoading ? (
          <div className="py-20 flex flex-col items-center justify-center gap-4 text-white/50">
            ...
            <span className="text-xs uppercase tracking-widest font-semibold">Retrieving Ledger History...</span>
          </div>
        ) : bookings.length === 0 ? (
          <div className="border border-[#D4AF37]/10 bg-white/5 rounded-3xl p-16 text-center max-w-lg mx-auto mt-12">
            <i className="fa-solid fa-clock-rotate-left text-5xl text-[#D4AF37]/35 mb-4 block"></i>
